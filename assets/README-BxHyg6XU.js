import{j as e}from"./index-Ln9-3d-e.js";function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",img:"img",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"ab64"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://github.com/un-ts/ab64/actions/workflows/ci.yml?query=branch%3Amain",children:e.jsx(n.img,{src:"https://img.shields.io/github/actions/workflow/status/un-ts/ab64/ci.yml?branch=main",alt:"GitHub Actions Workflow Status"})}),`
...
`,e.jsx(n.a,{href:"https://coderabbit.ai",children:e.jsx(n.img,{src:"https://img.shields.io/coderabbit/prs/github/un-ts/ab64",alt:"CodeRabbit Pull Request Reviews"})}),`
